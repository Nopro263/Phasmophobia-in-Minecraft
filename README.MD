![](./images/title.png "Phasmophobia in Minecraft")
...
`phasmo d​ot uns​er [d​​​​​o​t] dns​64 [​d​o​​t] de`
version `1.21.11`
...
the server will now listen on the port specified in `config.yml` and you can join on version `1.21.11`