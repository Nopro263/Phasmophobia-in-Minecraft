...
public class ExternalWrappedLightSource implements LightSource {
    ...
    private final PhasmoChunk[] owners;

    public ExternalWrappedLightSource(LightSource lightSource, PhasmoChunk... owners) {
